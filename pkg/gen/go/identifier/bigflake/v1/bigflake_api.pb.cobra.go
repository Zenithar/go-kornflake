...
var BigflakeAPIClientCommand = &cobra.Command{
	Use: "bigflakeAPI",
}

var bigflakeAPI_GetClientCommand = &cobra.Command{
	Use:  "get",
...
Authenticate using the Authorization header (requires transport security):
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		grpcClient := NewBigflakeAPIClient(conn)
...
func init() {
	BigflakeAPIClientCommand.AddCommand(bigflakeAPI_GetClientCommand)
	DefaultClientCommandConfig.AddFlags(bigflakeAPI_GetClientCommand.Flags())
}

...
var SnowflakeAPIClientCommand = &cobra.Command{
	Use: "snowflakeAPI",
}

var snowflakeAPI_GetClientCommand = &cobra.Command{
	Use:  "get",
...
Authenticate using the Authorization header (requires transport security):
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		grpcClient := NewSnowflakeAPIClient(conn)
...
func init() {
	SnowflakeAPIClientCommand.AddCommand(snowflakeAPI_GetClientCommand)
	DefaultClientCommandConfig.AddFlags(snowflakeAPI_GetClientCommand.Flags())
}
